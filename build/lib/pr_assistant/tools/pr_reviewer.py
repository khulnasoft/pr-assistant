...
class PRReviewer:
    ...
    def __init__(
        ...
        self.token_handler = TokenHandler(
            self.git_provider.pr, self.vars, get_settings().pr_review_prompt.system, get_settings().pr_review_prompt.user
        )
    ...
    def auto_approve_logic(self):
        ...
        if get_settings().pr_reviewer.enable_auto_approval:
            ...
            self.git_provider.publish_comment(
                "Auto-approval option for PR-Assistant is disabled. "
