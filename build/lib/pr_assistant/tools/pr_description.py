...
from pr_assistant.git_providers import GithubProvider, get_git_provider, get_git_provider_with_context
...
class PRDescription:
    ...
    async def _prepare_prediction(self, model: str) -> None:
        ...
        large_pr_handling = (
            get_settings().pr_description.enable_large_pr_handling and "pr_description_only_files_prompts" in get_settings()
        )
        output = get_pr_diff(
            self.git_provider, self.token_handler, model, large_pr_handling=large_pr_handling, return_remaining_files=True
        )
