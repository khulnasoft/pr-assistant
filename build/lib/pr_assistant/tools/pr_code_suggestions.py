...
from pr_assistant.algo.utils import ModelType, load_yaml, replace_code_tags, show_relevant_configurations
...
class PRCodeSuggestions:
    ...
    async def _prepare_prediction_extended(self, model: str) -> dict:
        self.patches_diff_list = get_pr_multi_diffs(
            self.git_provider, self.token_handler, model, max_calls=get_settings().pr_code_suggestions.max_number_of_calls
        )
