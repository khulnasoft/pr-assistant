...
from pr_assistant.algo.utils import ModelType, clip_tokens, get_max_tokens
...
def pr_generate_compressed_diff(
    top_langs: list, token_handler: TokenHandler, model: str, convert_hunks_to_line_numbers: bool, large_pr_handling: bool
