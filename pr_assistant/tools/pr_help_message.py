...
from pr_assistant.git_providers import GithubProvider, get_git_provider
...
class PRHelpMessage:
    ...
    async def run(self):
        try:
            ...
            pr_comment += (
                "Welcome to the PR Assistant, an AI-powered tool for automated pull request analysis, feedback, suggestions and more."
                ""
            )
